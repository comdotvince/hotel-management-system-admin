...
function RealTimeClock() {
  ...
  return (
    <div className="hms-clock" role="status" aria-live="polite">
      <p className="hms-clock-date">
        <span className="hms-clock-icon" aria-hidden="true">
      ...
      <p className="hms-clock-time">{timeFormatter.format(currentDate)}</p>
    </div>
  )
}
